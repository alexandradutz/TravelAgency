...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Update_t, stringdata) + ofs \
...
const QMetaObject Update::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Update.data,
...
void *Update::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Update.stringdata))
